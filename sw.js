...
const urlsToCache = [
  ...
  '/arletnails/vendor/react.production.min.js',
  '/arletnails/vendor/react-dom.production.min.js',
  '/arletnails/vendor/babel.min.js',
  '/arletnails/vendor/bcrypt.min.js',
  '/arletnails/vendor/tailwind-browser.js',
  '/arletnails/vendor/lucide/lucide.css',
  '/arletnails/vendor/lucide/lucide.woff2',
  '/arletnails/utils/push-config.js',
  '/arletnails/utils/push-notifications.js'
];
...
self.addEventListener('push', event => {
  ...
  const options = {
    ...
    icon: '/arletnails/icons/icon-192x192.png',
    badge: '/arletnails/icons/icon-96x96.png',
    tag: payload.tag || 'rservasroma',
    data: {
      url: payload.url || '/arletnails/admin.html',
      ...(payload.data || {})
    }
  };
...
self.addEventListener('notificationclick', event => {
  ...
  const targetUrl = event.notification?.data?.url || '/arletnails/admin.html';
  event.waitUntil(
